...
public class StartDoorItem extends ItemDoor {

	public static String modid = CCLMaze.MODID;

	public StartDoorItem() {
		super(Material.iron);
		this.setUnlocalizedName("start_door_item");
		this.setCreativeTab(MazeItems.mazeTab);
		this.setTextureName(CCLMaze.MODID + ":start_door_item");
	}
	...
	public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int par7, float par8, float par9, float par10) {
		if (par7 != 1) {
			...
			block = MazeBlocks.startDoorBlock;
